...
export const translations = {
  en: {
    translation: {
      ...
      attachment_input_hint: "Selected files will be added to the current input",
      attachment_images: "Images",
      attachment_image_limit: "PNG, JPG, GIF, WEBP, and other common image formats; up to 5 MB per file",
      attachment_videos: "Videos",
      attachment_video_limit: "MP4; up to 50 MB per file",
      attachment_generic_files: "General attachments",
      attachment_generic_formats: "PDF, DOCX, XLSX, CSV, PPTX, TXT, JSON, XML, MD, YAML, YML, TOML, LOG, ZIP",
      attachment_generic_size_limit: "Up to 25 MB per general attachment; ZIP up to 50 MB per file",
      attachment_message_limit: "Up to {{count}} general attachments per message, total size up to {{size}}",
      attachment_choose_file: "Choose file",
      attachment_file_type_error: "File type is not allowed!",
      attachment_file_size_error: "File is too large!",
      attachment_file_not_image: "File is not an image!",
      attachment_video_size_error: "Video is {{size}} MB, over the 50 MB limit. Compress and try again",
      attachment_mp4_only: "Only MP4 video files are supported",
      attachment_limit_count: "A single message can include up to {{count}} attachments",
      attachment_limit_size: "The total attachment size per message cannot exceed {{size}}",
      image_validation_error: "Image validation error",
      video_validation_error: "Video validation error",
      file_validation_error: "File validation error",
      attachment_limit_exceeded: "Attachment count or size limit exceeded",
      json_example_placeholder: 'Enter JSON data, for example:\n{\n  "key": "value"\n}',
      json_key_value_pairs: "Key-value pairs",
      json_object_required: "The value must be a JSON object",
      json_invalid: "Invalid JSON format",
      json_add_pair: "Add key-value pairs to configure data",
      json_enter_data: "Enter JSON data",
      json_key_placeholder: "Key",
      json_value_placeholder: "Value",
      json_add_field: "Add field",
      json_format: "Format",
      json_valid: "Valid JSON",
      combobox_select: "Select",
      combobox_search: "Search...",
      combobox_none: "None",
      combobox_no_match: "No matching items found",
      download_file: "Download {{fileName}}",
      log_file_utf8_required: "Log files must use UTF-8 encoding. Convert the file and try again.",
      message_copied: "Message copied",
      create_first_test_ticket: "Create a test ticket first",
      no_test_ticket: "No test ticket selected",
      no_test_tickets_create_first: "No test tickets. Create one first.",
      select_test_ticket: "Select a test ticket",
      select_test_ticket_description: "Select a ticket to start the test chat",
      unknown_error: "Unknown error",
      websocket_error: "WebSocket error",
      ticket_info_load_failed: "Failed to load ticket information",
      go_back: "Go back",
      reset: "Reset",
      reload: "Reload",
  ...
  zh: {
    translation: {
      ...
      attachment_supported_files: "支持上传的文件",
      attachment_input_hint: "选择文件后会加入当前输入框",
      attachment_images: "图片",
      attachment_image_limit: "PNG、JPG、GIF、WEBP 等常见图片格式，单个不超过 5 MB",
      attachment_videos: "视频",
      attachment_video_limit: "MP4，单个不超过 50 MB",
      attachment_generic_files: "普通附件",
      attachment_generic_formats: "PDF、DOCX、XLSX、CSV、PPTX、TXT、JSON、XML、MD、YAML、YML、TOML、LOG、ZIP",
      attachment_generic_size_limit: "普通附件单个不超过 25 MB；ZIP 单个不超过 50 MB",
      attachment_message_limit: "单条消息最多 {{count}} 个普通附件，总大小不超过 {{size}}",
      attachment_choose_file: "选择文件",
      attachment_file_type_error: "文件类型不允许！",
      attachment_file_size_error: "文件太大！",
      attachment_file_not_image: "文件不是图片！",
      attachment_video_size_error: "视频大小为 {{size}} MB，超过 50 MB 上限，请压缩后重试",
      attachment_mp4_only: "仅支持 MP4 视频文件",
      attachment_limit_count: "单条消息最多添加 {{count}} 个附件",
      attachment_limit_size: "单条消息附件总大小不能超过 {{size}}",
      image_validation_error: "图片验证错误",
      video_validation_error: "视频验证错误",
      file_validation_error: "文件验证错误",
      attachment_limit_exceeded: "附件数量或大小超限",
      json_example_placeholder: '输入 JSON 格式的数据，例如：\n{\n  "key": "value"\n}',
      json_key_value_pairs: "键值对",
      json_object_required: "必须是对象格式",
      json_invalid: "JSON 格式错误",
      json_add_pair: "添加键值对来配置数据",
      json_enter_data: "输入 JSON 格式的数据",
      json_key_placeholder: "键名",
      json_value_placeholder: "值",
      json_add_field: "添加字段",
      json_format: "格式化",
      ...
      combobox_search: "搜索...",
      combobox_none: "不选择",
      combobox_no_match: "未找到匹配项",
      download_file: "下载 {{fileName}}",
      log_file_utf8_required: "日志文件需要使用 UTF-8 编码，请转换后重试",
      message_copied: "已复制消息",
      create_first_test_ticket: "点击 + 按钮创建你的第一个测试 ticket",
      no_test_ticket: "没有测试 Ticket",
      no_test_tickets_create_first: "暂无测试工单,点击创建第一个测试工单",
      select_test_ticket: "选择一个测试 Ticket",
      select_test_ticket_description: "从侧边栏选择一个测试 ticket 开始测试",
      unknown_error: "未知错误",
      websocket_error: "WebSocket 错误",
      ticket_info_load_failed: "获取 ticket 信息失败",
      go_back: "返回",
      reset: "重置",
      reload: "刷新",
      reset_login: "重置登录信息",
