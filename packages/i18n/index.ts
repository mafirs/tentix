  ...
  en: {
    translation: {
      ...
      knowledge_error: {
        ...
        chunk_size: "Custom chunk length must be between 64 and 4000", title_depth: "Title recognition depth must be from H1 to H8", candidates_max: "More than 100 candidates were parsed. Split the file.",
  ...
  zh: {
    translation: {
      ...
      knowledge_error: {
        ...
        chunk_size: "自定义分块长度必须在 64 到 4000 之间", title_depth: "标题识别层级必须在 H1 到 H8 之间", candidates_max: "解析结果超过 100 条，请拆分文件",
