  ...
  en: {
    translation: {
      ...
      tktH: {
        ...
        makeRequest: "Requirement raised",
        close: "$t(tkt) closed",
        other: "Other",
      },
      info: "Information",
      ...
      rf: {
        ...
        condition: {
          ...
          add: "Add Condition",
          expression_placeholder: "Enter a condition expression",
          empty:
            "No output conditions yet. Click \"Add Condition\" to create one.",
        },
        smartChat: {
          enable_vision: "Enable Vision",
          include_ticket_image: "Include ticket description images",
        },
        emotion: {
          detection_settings: "Detection Settings",
        },
        rag: {
          enable_intent_analysis: "Enable Intent Analysis",
          intent_system_prompt: "Intent Analysis System Prompt",
          intent_user_prompt: "Intent Analysis User Prompt",
          intent_llm_model: "Intent Analysis LLM - Model",
          intent_llm_base_url: "Intent Analysis LLM - Base URL",
          intent_llm_api_key: "Intent Analysis LLM - API Key",
          generate_query: "Generate Retrieval Query",
          query_system_prompt: "Generate Retrieval Query System Prompt",
          query_user_prompt: "Generate Retrieval Query User Prompt",
          query_llm_model: "Generate Retrieval Query LLM - Model",
          query_llm_base_url: "Generate Retrieval Query LLM - Base URL",
          query_llm_api_key: "Generate Retrieval Query LLM - API Key",
        },
        escalation: {
          message_template: "Escalation offer message template",
        },
        handoff: {
          message_template: "Message Template",
          message_template_placeholder: "Enter a message template...",
          channel: "Notification Channel",
          channel_placeholder: "Select a channel",
          channel_lark: "Lark",
          channel_lark_desc: "Send the notification via Lark",
          channel_email: "Email",
          channel_email_desc: "Send the notification via email",
          channel_wecom: "WeCom",
          channel_wecom_desc: "Send the notification via WeCom",
          channel_sms: "SMS",
          channel_sms_desc: "Send the notification via SMS",
        },
        edge: {
      ...
      attachment_add_to_input: "Selected files are added to the current input",
      attachment_image: "Images",
      attachment_image_description: "PNG, JPG, GIF, WEBP and other common image formats, up to 5 MB each",
      attachment_video: "Videos",
      attachment_video_description: "MP4, up to 50 MB each",
      attachment_generic: "Attachments",
      attachment_generic_description: "Up to 25 MB each; ZIP up to 50 MB",
      attachment_per_message_limit: "Up to 5 attachments per message, 50 MB in total",
      attachment_choose_file: "Select file",
      attachment_max_count: "You can add up to 5 attachments per message",
      attachment_max_total_size: "Attachments in one message cannot exceed 50 MB in total",
      attachment_file_type_invalid: "File type not allowed",
      attachment_file_too_large: "File is too large",
      attachment_file_not_image: "File is not an image",
      attachment_video_too_large: "Video is {{size}} MB, which exceeds the 50 MB limit. Compress it and try again",
      attachment_video_type_invalid: "Only MP4 videos are supported",
      attachment_image_validation_error: "Image validation error",
      attachment_video_validation_error: "Video validation error",
      attachment_file_validation_error: "File validation error",
      attachment_limit_error: "Attachment count or size limit exceeded",
      chat_download_file: "Download {{fileName}}",
      upload_utf8_log_required: "Log files must be UTF-8 encoded. Convert the file and try again",
      ticket_sort_newest: "Newest first",
      ticket_sort_oldest: "Oldest first",
      ticket_sort_default: "Default sort",
      ticket_list_page_title: "Tickets | Tentix",
      ticket_page_title: "Ticket #{{id}} | Tentix",
      websocket_connection_failed: "WebSocket connection failed, please check your network and retry",
      websocket_connection_closed: "Connection closed",
      websocket_connection_expired: "Connection expired, please refresh the page and retry",
      websocket_ticket_id_missing: "Ticket ID is missing",
      websocket_token_missing: "WebSocket token is missing",
      websocket_send_timeout: "Sending timed out, please retry",
      websocket_connection_lost: "Connection lost",
      websocket_connect_failed: "WebSocket connection failed",
      workflow_page_title: "Workflow #{{id}} | Tentix",
      workflow_test_env_required: "Please fill in zone and namespace",
      workflow_test_env_description: "These parameters are used by the MCP node only in chat tests",
      workflow_test_env_saved: "Saved",
      workflow_test_env_saved_description: "Applies to chat tests only; reopen or reconnect the chat test to take effect",
      workflow_test_env_cleared: "Cleared",
      workflow_test_env_cleared_description: "Cleared zone/namespace for chat tests; they will no longer be sent",
      workflow_node_start_description: "Entry node",
      workflow_node_mcp_description: "Writes to variables.mcp (stub)",
      workflow_node_smart_chat_description: "AI conversation",
      workflow_node_rag_description: "RAG retrieval",
      workflow_node_emotion_description: "Detect emotion",
      workflow_node_escalation_description: "Whether to escalate",
      workflow_node_handoff_description: "Human takeover",
      workflow_node_end_description: "End node",
      workflow_save_success: "Workflow saved successfully",
      workflow_save_failed: "Failed to save workflow, please try again",
      workflow_load_failed: "Failed to load",
      workflow_back: "Back",
      workflow_add_node: "Add node",
      workflow_test_chat: "Chat test",
      workflow_settings: "Settings",
      workflow_save: "Save",
      workflow_test_settings_title: "Chat test settings",
      workflow_test_settings_description: "The zone and namespace configured here are passed to the MCP node only during chat tests and do not affect any production service.",
      workflow_test_zone_placeholder: "e.g. cn-shanghai",
      workflow_test_namespace_placeholder: "e.g. ns-xxxxxx",
      workflow_test_settings_clear: "Clear",
      workflow_ws_missing: "WebSocket not found",
      workflow_ws_reconnect: "Please reconnect",
      workflow_ws_not_ready: "WebSocket is not ready",
      workflow_ws_retry_later: "Please try again later",
      workflow_message_send_failed: "Failed to send message",
      workflow_unknown_error: "Unknown error",
      workflow_message_error: "Message error",
      workflow_message_wrong_ticket: "Message belongs to a different ticket: {{ticketId}}",
      workflow_info: "WebSocket info",
      workflow_message_handle_failed: "Failed to handle message",
      workflow_connect_failed: "Unable to connect",
      workflow_select_test_ticket: "Please select a test ticket",
      test_chat_ticket_info_failed: "Failed to fetch ticket info",
      test_chat_websocket_error: "WebSocket error",
      test_chat_copied_message: "Message copied",
      test_chat_no_tickets: "No test tickets",
      test_chat_create_first_ticket: "Click + to create your first test ticket",
      test_chat_select_ticket: "Select a test ticket",
      test_chat_select_ticket_description:
        "Select a test ticket from the sidebar to start testing",
      workflow_id_required: "Workflow ID is required",
      workflow_login_required: "Please log in first",
      workflow_connection_error: "WebSocket connection error",
      workflow_connection_failed_detail: "WebSocket connection failed, check network, proxy, or port forwarding",
      workflow_no_test_ticket: "No test ticket selected",
      workflow_send_timeout: "Send timed out, please retry",
      staff_identity_verifying: "Verifying identity...",
      user_search_placeholder: "Search users (name, ID, real name)",
      user_filter_role: "Filter by role",
      user_all_roles: "All roles",
      user_role_customer: "Customer",
      user_role_agent: "Agent",
      user_role_technician: "Technician",
      user_role_admin: "Admin",
      user_create: "Create user",
      user_identity_information: "User identity information",
      user_nickname: "Nickname",
      user_phone: "Phone",
      user_level: "Level",
      user_create_dialog_title: "Create a new user",
      user_create_dialog_description: "Create a new user account. Fields marked * are required.",
      user_create_section_details: "Details",
      user_create_name_placeholder: "Enter a username",
      user_create_password_placeholder: "Enter a password (at least 6 characters)",
      user_create_role_placeholder: "Select a user role",
      user_create_real_name_placeholder: "Enter the real name",
      user_create_nickname_placeholder: "Enter a nickname",
      user_create_email_placeholder: "Enter an email address",
      user_create_phone_label: "Phone Number",
      user_create_phone_placeholder: "Enter a phone number",
      user_create_meta_label: "Meta Data",
      user_create_meta_description: "Add key-value pairs to configure extra user data",
      json_editor_placeholder:
        "Enter JSON data, e.g.:\n{\n  \"key\": \"value\"\n}",
      json_editor_must_be_object: "Must be an object",
      json_editor_invalid: "Invalid JSON",
      json_editor_mode_pairs: "Key-value",
      json_editor_description_pairs: "Add key-value pairs to configure data",
      json_editor_description_json: "Enter JSON data",
      json_editor_key_placeholder: "Key",
      json_editor_value_placeholder: "Value",
      json_editor_add_field: "Add field",
      json_editor_format: "Format",
      json_editor_valid: "Valid JSON",
      user_create_meta_placeholder: "Enter JSON data, e.g.:\n{\n  \"department\": \"Engineering\",\n  \"customField\": \"custom value\"\n}",
      user_create_success: "User created successfully",
      user_creating: "Creating...",
      username_required: "Username is required",
      username_min: "Username must be at least 3 characters",
      username_max: "Username cannot exceed 50 characters",
      username_pattern: "Only letters, numbers, underscores and Chinese characters are allowed",
      password_min: "Password must be at least 6 characters",
      password_max: "Password cannot exceed 100 characters",
      real_name_max: "Real name cannot exceed 50 characters",
      phone_invalid: "Invalid phone number format",
      nickname_max: "Nickname cannot exceed 30 characters",
      email_invalid: "Please enter a valid email address",
      user_page_summary: "Showing {{from}} - {{to}} of {{total}}",
      user_management: "User Management",
      workflow_name_required: "Name is required",
      source_part_required: "This field is required",
      source_part_max: "Must be at most {{count}} characters",
      source_part_pattern: "Only letters, numbers, underscores, and hyphens are allowed",
      kb_title_required: "Title is required",
      kb_modules_required: "Select at least one module",
      kb_modules_max: "At most {{count}} modules",
      kb_revision_required: "Version is required",
      kb_content_required: "Content is required",
      kb_index_length_max: "A recall index cannot exceed {{count}} characters",
      kb_featured_cases: "Featured cases",
      kb_historical_tickets: "Historical tickets",
      kb_all_knowledge: "General knowledge",
      kb_general_add_failed: "Failed to add general knowledge",
      kb_index_generate_failed: "Failed to generate recall indexes",
      relative_just_now: "Just now",
      relative_minutes: "{{count}} minutes ago",
      relative_hours: "{{count}} hours ago",
      relative_days: "{{count}} days ago",
      relative_months: "{{count}} months ago",
      relative_years: "{{count}} years ago",
      ai_tab_roles: "AI roles",
      ai_tab_workflows: "Workflows",
      ai_tab_knowledge: "Knowledge base",
      ai_role_search: "Search AI roles",
      workflow_update_failed: "Update failed",
      ai_select_image: "Select an image file",
      ai_image_size_limit: "Image size cannot exceed 5 MB",
      ai_avatar_updated: "Avatar updated",
      ai_avatar_update_failed: "Failed to update avatar",
      ai_name_updated: "Name updated",
      ai_name_update_failed: "Failed to update name",
      ai_name_placeholder: "Enter a name",
      ai_answer_scope: "Answer scope",
      ai_all_scope: "All modules",
      ai_scope_updated: "Answer scope updated",
      ai_select_scope: "Select scope",
      ai_search_scope: "Search scopes...",
      ai_workflow_label: "Workflow",
      workflow_updated: "Workflow updated",
      ai_select_workflow: "Select workflow",
      ai_search_workflow: "Search workflows...",
      ai_no_workflow: "No workflow",
      ai_created_at: "Created: {{time}}",
      ai_updated_at: "Updated: {{time}}",
      ai_active_status: "Active",
      ai_status_updated: "Active status updated",
      workflow_delete_failed: "Delete failed",
      workflow_deleted: "Deleted",
      workflow_search: "Search workflows",
      workflow_create_title: "New workflow",
      workflow_create_failed: "Create failed",
      workflow_create_success: "Workflow created",
      workflow_name: "Name",
      workflow_name_placeholder: "Enter a name",
      workflow_description: "Description",
      workflow_optional: "Optional",
      workflow_creating: "Creating...",
      workflow_last_edited: "Last edited {{time}}",
      workflow_edit: "Edit",
      workflow_delete: "Delete",
      kb_save_failed: "Save failed",
      kb_chunk_update_failed: "Failed to update chunk status",
      kb_delete_failed: "Delete failed",
      kb_deleted: "Deleted",
      kb_general_added: "General knowledge added",
      kb_no_valid_indexes: "No valid recall indexes generated",
      kb_index_exists: "Recall indexes already exist and were not overwritten",
      kb_index_generated: "Recall indexes generated",
      kb_required_fields: "Fill in the title, applicable modules, knowledge type, and content first",
      kb_content_not_editable: "General knowledge content cannot be saved here",
      kb_no_index_changes: "No recall index changes to save",
      kb_index_too_long: "A recall index cannot be empty or exceed 500 characters",
      kb_index_saved: "Recall indexes saved and rebuilt",
      kb_no_changes: "No changes to save",
      kb_saved_rebuilt: "Saved and indexes rebuilt",
      kb_reenabled: "Re-enabled",
      list_separator: ",",
      kb_unmodularized: "No module",
      kb_add_general_title: "Add general knowledge",
      kb_adding: "Adding",
      kb_available: "Available knowledge",
      kb_chunks: "Knowledge chunks",
      kb_disabled_status: "Disabled",
      kb_filtering: "Filtering",
      kb_sync_failed: "Sync failed",
      kb_normal: "Normal",
      kb_click_filter: "Click to filter",
      kb_search_placeholder: "Search title, content, tags, knowledge ID, ticket ID...",
      kb_source: "Source",
      kb_all_sources: "All sources",
      kb_all_modules: "All modules",
      kb_all_statuses: "All statuses",
      kb_enabled_status: "Enabled",
      kb_filter_disabled: "Disabled",
      kb_loading_failed: "Failed to load knowledge base",
      kb_no_failed_content: "No failed sync content",
      kb_has_disabled: "Has disabled",
      kb_chunk_count: "{{count}} chunks",
      kb_hit_count: "{{count}} hits",
      kb_pagination: "{{total}} total · Page {{current}} / {{totalPages}}",
      kb_select_knowledge: "Select a knowledge entry",
      kb_detail_failed: "Failed to load knowledge details",
      kb_sync_failed_detail: "Sync failed. Review the original content that failed to import, then open the ticket to handle it or delete the failed record.",
      kb_ticket_id: "Ticket ID",
      kb_open_ticket: "Open ticket",
      kb_uncategorized: "Uncategorized",
      kb_import_scope: "Import scope",
      kb_entire_conversation: "Entire conversation",
      kb_selected_messages: "Selected messages",
      kb_chunks_label: "Chunks",
      kb_hits_label: "Hits",
      kb_tags: "Tags",
      kb_content_chunks: "Content chunks",
      kb_recall_only_editable: "Only recall indexes are editable; formal knowledge content stays read-only",
      kb_not_saved_to_db: "Not written to the database until you save",
      kb_formal_knowledge: "Formal knowledge",
      kb_ai_summary: "AI summary",
      kb_original_content: "Original content {{index}}",
      kb_reenable: "Enable",
      kb_save_and_rebuild: "Save and rebuild indexes",
      kb_delete_failed_record: "Delete failed record",
      kb_confirm_delete: "Confirm knowledge deletion",
      kb_delete_failed_description: "This removes the failed sync record.",
      kb_delete_no_knowledge: "If this record never generated knowledge content, existing available knowledge is unaffected.",
      kb_delete_all_chunks: "This removes all chunks of this knowledge entry.",
      kb_cascade_warning: "Related hit records are deleted in cascade, so historical hit analytics will decrease.",
      kb_confirm_delete_button: "Delete",
      kb_failed_content: "Failed import content",
      kb_original_message_full: "Full original messages",
      kb_no_original_message: "No original message content found",
      message_recalled: "Withdrawn",
      kb_empty_message: "(Empty message)",
      ai_manage_users: "Go to user management to configure AI roles",
      ai_no_roles: "No AI roles yet",
      ai_no_roles_description: "No AI roles have been configured. Go to user management to set a user as an AI role.",
      workflow_create_submit: "Submit",
      kb_disable: "Disable",
      kb_add_general: "Add",
      kb_no_knowledge: "No knowledge content",
      kb_recall_index: "Recall index",
      delete: "Delete",
      combobox_placeholder: "Select",
      combobox_search_placeholder: "Search...",
      combobox_none_label: "None",
      combobox_no_match: "No matches found",
      not_login_message:
        "You are not signed in properly. Please close the app, refresh the page, and enter again.",
      analytics_loading: "Loading analytics...",
      all_tickets_page_title: "All tickets | Tentix",
      test_ticket_sidebar_empty:
        "No test tickets yet. Click to create your first test ticket.",
      relative_minutes_one: "1 minute ago",
      relative_hours_one: "1 hour ago",
      relative_days_one: "1 day ago",
      relative_months_one: "1 month ago",
      relative_years_one: "1 year ago",
    },
  },
  zh: {
    translation: {
      ...
      rf: {
        ...
        condition: {
          output_conditions: "输出条件",
          add: "添加条件",
          expression_placeholder: "输入条件表达式",
          empty: "暂无输出条件，点击「添加条件」创建",
        },
        smartChat: {
          enable_vision: "启用视觉",
          include_ticket_image: "包含工单描述图片",
        },
        emotion: {
          detection_settings: "检测配置",
        },
        rag: {
          enable_intent_analysis: "启用意图分析",
          intent_system_prompt: "意图分析 System Prompt",
          intent_user_prompt: "意图分析 User Prompt",
          intent_llm_model: "意图分析 LLM - Model",
          intent_llm_base_url: "意图分析 LLM - Base URL",
          intent_llm_api_key: "意图分析 LLM - API Key",
          generate_query: "生成检索语",
          query_system_prompt: "生成检索语 System Prompt",
          query_user_prompt: "生成检索语 User Prompt",
          query_llm_model: "生成检索语 LLM - Model",
          query_llm_base_url: "生成检索语 LLM - Base URL",
          query_llm_api_key: "生成检索语 LLM - API Key",
        },
        escalation: {
          message_template: "升级询问消息模板",
        },
        handoff: {
          message_template: "消息模板",
          message_template_placeholder: "输入消息模板...",
          channel: "通知渠道",
          channel_placeholder: "请选择渠道",
          channel_lark: "飞书",
          channel_lark_desc: "通过飞书发送通知",
          channel_email: "邮箱",
          channel_email_desc: "通过邮件发送通知",
          channel_wecom: "企业微信",
          channel_wecom_desc: "通过企业微信发送通知",
          channel_sms: "短信",
          channel_sms_desc: "通过短信发送通知",
        },
        edge: {
      ...
      attachment_add_to_input: "选择文件后会加入当前输入框",
      attachment_image: "图片",
      attachment_image_description: "PNG、JPG、GIF、WEBP 等常见图片格式，单个不超过 5 MB",
      attachment_video: "视频",
      attachment_video_description: "MP4，单个不超过 50 MB",
      attachment_generic: "普通附件",
      attachment_generic_description: "普通附件单个不超过 25 MB；ZIP 单个不超过 50 MB",
      attachment_per_message_limit: "单条消息最多 5 个普通附件，总大小不超过 50 MB",
      attachment_choose_file: "选择文件",
      attachment_max_count: "单条消息最多添加 5 个附件",
      attachment_max_total_size: "单条消息附件总大小不能超过 50 MB",
      attachment_file_type_invalid: "文件类型不允许！",
      attachment_file_too_large: "文件太大！",
      attachment_file_not_image: "文件不是图片！",
      attachment_video_too_large: "视频大小为 {{size}} MB，超过 50 MB 上限，请压缩后重试",
      attachment_video_type_invalid: "仅支持 MP4 视频文件",
      attachment_image_validation_error: "图片验证错误",
      attachment_video_validation_error: "视频验证错误",
      attachment_file_validation_error: "文件验证错误",
      attachment_limit_error: "附件数量或大小超限",
      chat_download_file: "下载 {{fileName}}",
      upload_utf8_log_required: "日志文件需要使用 UTF-8 编码，请转换后重试",
      ticket_sort_newest: "最新优先",
      ticket_sort_oldest: "最旧优先",
      ticket_sort_default: "默认排序",
      ticket_list_page_title: "工单列表 | Tentix",
      ticket_page_title: "工单#{{id}} | Tentix",
      websocket_connection_failed: "WebSocket 连接失败，请检查网络后重试",
      websocket_connection_closed: "连接已关闭",
      websocket_connection_expired: "连接已过期，请刷新页面后重试",
      websocket_ticket_id_missing: "ticketId 未设置",
      websocket_token_missing: "WebSocket token 未设置",
      websocket_send_timeout: "发送超时，请重试",
      websocket_connection_lost: "连接已断开",
      websocket_connect_failed: "WebSocket 连接失败",
      workflow_page_title: "工作流 #{{id}} | Tentix",
      workflow_test_env_required: "请填写 zone 和 namespace",
      workflow_test_env_description: "这两个参数仅在“对话测试”中给 MCP 节点使用",
      workflow_test_env_saved: "已保存",
      workflow_test_env_saved_description: "仅对对话测试生效（需要重新打开对话测试/重新连接后生效）",
      workflow_test_env_cleared: "已清空",
      workflow_test_env_cleared_description: "已清空对话测试的 zone/namespace；之后对话测试将不再传参",
      workflow_node_start_description: "入口节点",
      workflow_node_mcp_description: "写入 variables.mcp（stub）",
      workflow_node_smart_chat_description: "AI 对话",
      workflow_node_rag_description: "RAG 检索",
      workflow_node_emotion_description: "识别情绪",
      workflow_node_escalation_description: "是否升级",
      workflow_node_handoff_description: "人工接管",
      workflow_node_end_description: "终点",
      workflow_save_success: "工作流保存成功",
      workflow_save_failed: "工作流保存失败，请重试",
      workflow_load_failed: "加载失败",
      workflow_back: "返回",
      workflow_add_node: "添加节点",
      workflow_test_chat: "对话测试",
      workflow_settings: "设置",
      workflow_save: "保存",
      workflow_test_settings_title: "对话测试设置",
      workflow_test_settings_description: "这里配置的 zone / namespace 仅在“对话测试”时传给 MCP 节点使用，不影响任何线上服务。",
      workflow_test_zone_placeholder: "例如：cn-shanghai",
      workflow_test_namespace_placeholder: "例如：ns-xxxxxx",
      workflow_test_settings_clear: "清空",
      workflow_ws_missing: "WebSocket 不存在",
      workflow_ws_reconnect: "请重新连接",
      workflow_ws_not_ready: "WebSocket 连接未就绪",
      workflow_ws_retry_later: "请稍后再试",
      workflow_message_send_failed: "消息发送失败",
      workflow_unknown_error: "未知错误",
      workflow_message_error: "消息错误",
      workflow_message_wrong_ticket: "收到的消息属于不同的 ticket: {{ticketId}}",
      workflow_info: "WebSocket 信息",
      workflow_message_handle_failed: "消息处理失败",
      workflow_connect_failed: "无法连接",
      workflow_select_test_ticket: "请选择一个测试 ticket",
      test_chat_ticket_info_failed: "获取 ticket 信息失败",
      test_chat_websocket_error: "WebSocket 错误",
      test_chat_copied_message: "已复制消息",
      test_chat_no_tickets: "没有测试 Ticket",
      test_chat_create_first_ticket: "点击 + 按钮创建你的第一个测试 ticket",
      test_chat_select_ticket: "选择一个测试 Ticket",
      test_chat_select_ticket_description: "从侧边栏选择一个测试 ticket 开始测试",
      workflow_id_required: "需要 Workflow ID",
      workflow_login_required: "请先登录",
      workflow_connection_error: "WebSocket 连接错误",
      workflow_connection_failed_detail: "WebSocket 连接失败，请检查网络/代理/端口转发",
      workflow_no_test_ticket: "没有选择 test ticket",
      workflow_send_timeout: "发送超时,请重试",
      staff_identity_verifying: "正在验证身份...",
      user_search_placeholder: "搜索用户（姓名、ID、真实姓名）",
      user_filter_role: "按角色筛选",
      user_all_roles: "全部角色",
      user_role_customer: "客户",
      user_role_agent: "客服",
      user_role_technician: "技术员",
      user_role_admin: "管理员",
      user_create: "创建用户",
      user_identity_information: "用户身份信息",
      user_nickname: "昵称",
      user_phone: "手机号",
      user_level: "级别",
      user_create_dialog_title: "创建新用户",
      user_create_dialog_description: "创建新的用户账号。标有 * 的字段为必填项。",
      user_create_section_details: "详细信息",
      user_create_name_placeholder: "输入用户名",
      user_create_password_placeholder: "输入密码（至少6位字符）",
      user_create_role_placeholder: "选择用户角色",
      user_create_real_name_placeholder: "输入真实姓名",
      user_create_nickname_placeholder: "输入昵称",
      user_create_email_placeholder: "输入邮箱地址",
      user_create_phone_label: "电话号码",
      user_create_phone_placeholder: "输入电话号码",
      user_create_meta_label: "Meta 数据",
      user_create_meta_description: "添加键值对来配置额外的用户数据",
      json_editor_placeholder:
        "输入 JSON 格式的数据，例如：\n{\n  \"key\": \"value\"\n}",
      json_editor_must_be_object: "必须是对象格式",
      json_editor_invalid: "JSON 格式错误",
      json_editor_mode_pairs: "键值对",
      json_editor_description_pairs: "添加键值对来配置数据",
      json_editor_description_json: "输入 JSON 格式的数据",
      json_editor_key_placeholder: "键名",
      json_editor_value_placeholder: "值",
      json_editor_add_field: "添加字段",
      json_editor_format: "格式化",
      json_editor_valid: "JSON 格式正确",
      user_create_meta_placeholder: "输入 JSON 格式的数据，例如：\n{\n  \"department\": \"技术部\",\n  \"customField\": \"自定义值\"\n}",
      user_create_success: "用户创建成功",
      user_creating: "创建中...",
      username_required: "用户名不能为空",
      username_min: "用户名至少3个字符",
      username_max: "用户名不能超过50个字符",
      username_pattern: "用户名只能包含字母、数字、下划线和中文字符",
      password_min: "密码至少6个字符",
      password_max: "密码不能超过100个字符",
      real_name_max: "真实姓名不能超过50个字符",
      phone_invalid: "手机号格式不正确",
      nickname_max: "昵称不能超过30个字符",
      email_invalid: "请输入有效的邮箱地址",
      user_page_summary: "显示 {{from}} - {{to}} 条，共 {{total}} 条",
      user_management: "用户管理",
      workflow_name_required: "名称不能为空",
      source_part_required: "不能为空",
      source_part_max: "不能超过 {{count}} 个字符",
      source_part_pattern: "仅支持字母、数字、下划线和短横线",
      kb_title_required: "标题不能为空",
      kb_modules_required: "至少选择一个模块",
      kb_modules_max: "模块数量不能超过 {{count}} 个",
      kb_revision_required: "版本不能为空",
      kb_content_required: "正文不能为空",
      kb_index_length_max: "召回索引不能超过 {{count}} 个字符",
      kb_featured_cases: "精选案例",
      kb_historical_tickets: "历史工单",
      kb_all_knowledge: "通用知识",
      kb_general_add_failed: "添加通用知识失败",
      kb_index_generate_failed: "召回索引生成失败",
      relative_just_now: "刚刚",
      relative_minutes: "{{count}} 分钟前",
      relative_hours: "{{count}} 小时前",
      relative_days: "{{count}} 天前",
      relative_months: "{{count}} 个月前",
      relative_years: "{{count}} 年前",
      ai_tab_roles: "AI角色",
      ai_tab_workflows: "工作流",
      ai_tab_knowledge: "知识库",
      ai_role_search: "搜索 AI 角色",
      workflow_update_failed: "更新失败",
      ai_select_image: "请选择图片文件",
      ai_image_size_limit: "图片大小不能超过5MB",
      ai_avatar_updated: "头像已更新",
      ai_avatar_update_failed: "头像更新失败",
      ai_name_updated: "名称已更新",
      ai_name_update_failed: "名称更新失败",
      ai_name_placeholder: "输入名称",
      ai_answer_scope: "回答范围",
      ai_all_scope: "全部范围",
      ai_scope_updated: "已更新回答范围",
      ai_select_scope: "选择范围",
      ai_search_scope: "搜索范围...",
      ai_workflow_label: "工作流",
      workflow_updated: "已更新工作流",
      ai_select_workflow: "选择工作流",
      ai_search_workflow: "搜索工作流...",
      ai_no_workflow: "不绑定工作流",
      ai_created_at: "创建：{{time}}",
      ai_updated_at: "更新：{{time}}",
      ai_active_status: "激活状态",
      ai_status_updated: "已更新激活状态",
      workflow_delete_failed: "删除失败",
      workflow_deleted: "已删除",
      workflow_search: "搜索工作流",
      workflow_create_title: "新建工作流",
      workflow_create_failed: "创建失败",
      workflow_create_success: "创建成功",
      workflow_name: "名称",
      workflow_name_placeholder: "请输入名称",
      workflow_description: "描述",
      workflow_optional: "可选",
      workflow_creating: "创建中...",
      workflow_last_edited: "最近编辑于 {{time}}",
      workflow_edit: "编辑",
      workflow_delete: "删除",
      kb_save_failed: "保存失败",
      kb_chunk_update_failed: "更新片段状态失败",
      kb_delete_failed: "删除失败",
      kb_deleted: "已删除",
      kb_general_added: "通用知识已添加",
      kb_no_valid_indexes: "未生成有效召回索引",
      kb_index_exists: "召回索引已存在，未覆盖",
      kb_index_generated: "召回索引已生成",
      kb_required_fields: "请先填写标题、适用模块、知识类型和正文",
      kb_content_not_editable: "通用知识正文暂不支持在此保存",
      kb_no_index_changes: "没有需要保存的召回索引改动",
      kb_index_too_long: "召回索引不能为空且不能超过 500 个字符",
      kb_index_saved: "召回索引已保存并重建",
      kb_no_changes: "没有需要保存的改动",
      kb_saved_rebuilt: "已保存并重建索引",
      kb_reenabled: "已解除禁用",
      list_separator: "、",
      kb_unmodularized: "未分模块",
      kb_add_general_title: "添加通用知识",
      kb_adding: "添加中",
      kb_available: "可用知识",
      kb_chunks: "知识片段",
      kb_disabled_status: "已禁用",
      kb_filtering: "筛选中",
      kb_sync_failed: "同步失败",
      kb_normal: "正常",
      kb_click_filter: "点击筛选",
      kb_search_placeholder: "搜索标题、内容、标签、知识 ID、工单 ID...",
      kb_source: "来源",
      kb_all_sources: "全部来源",
      kb_all_modules: "全部模块",
      kb_all_statuses: "全部状态",
      kb_enabled_status: "启用",
      kb_filter_disabled: "禁用",
      kb_loading_failed: "知识库加载失败",
      kb_no_failed_content: "暂无同步失败内容",
      kb_has_disabled: "有禁用",
      kb_chunk_count: "{{count}} 片段",
      kb_hit_count: "{{count}} 命中",
      kb_pagination: "共 {{total}} 条 · 第 {{current}} / {{totalPages}} 页",
      kb_select_knowledge: "请选择一条知识",
      kb_detail_failed: "知识详情加载失败",
      kb_sync_failed_detail: "同步失败。请查看导入失败的原始内容，确认后可打开工单处理或删除失败记录。",
      kb_ticket_id: "工单 ID",
      kb_open_ticket: "打开工单",
      kb_uncategorized: "未分类",
      kb_import_scope: "导入范围",
      kb_entire_conversation: "整段对话",
      kb_selected_messages: "选中消息",
      kb_chunks_label: "片段",
      kb_hits_label: "命中",
      kb_tags: "标签",
      kb_content_chunks: "内容片段",
      kb_recall_only_editable: "仅召回索引可编辑，正式知识正文保持只读",
      kb_not_saved_to_db: "未点击保存前不会写入数据库",
      kb_formal_knowledge: "正式知识",
      kb_ai_summary: "AI 摘要",
      kb_original_content: "原始内容 {{index}}",
      kb_reenable: "解除禁用",
      kb_save_and_rebuild: "保存并重建索引",
      kb_delete_failed_record: "删除失败记录",
      kb_confirm_delete: "确认删除知识",
      kb_delete_failed_description: "删除后会移除这条同步失败记录。",
      kb_delete_no_knowledge: "如果这条记录没有成功生成过知识内容，不会影响现有可用知识。",
      kb_delete_all_chunks: "删除后会移除这条知识的全部片段。",
      kb_cascade_warning: "相关命中记录会被级联删除，历史命中分析数据会减少。",
      kb_confirm_delete_button: "确定删除",
      kb_failed_content: "导入失败的内容",
      kb_original_message_full: "原始消息全文",
      kb_no_original_message: "未找到原始消息内容",
      message_recalled: "已撤回",
      kb_empty_message: "（空消息）",
      ai_manage_users: "前往用户管理，设置AI角色",
      ai_no_roles: "暂无AI角色",
      ai_no_roles_description: "还没有配置任何AI角色。点击前往用户管理，将用户设置为AI角色。",
      workflow_create_submit: "提交",
      kb_disable: "禁用",
      kb_add_general: "添加",
      kb_no_knowledge: "暂无知识内容",
      kb_recall_index: "召回索引",
      delete: "删除",
      combobox_placeholder: "请选择",
      combobox_search_placeholder: "搜索...",
      combobox_none_label: "不选择",
      combobox_no_match: "未找到匹配项",
      not_login_message:
        "当前您未正常登录，请关闭应用。刷新页面后，重新进入此应用！",
      analytics_loading: "正在加载数据分析...",
      all_tickets_page_title: "全部工单列表 | Tentix",
      test_ticket_sidebar_empty: "暂无测试工单,点击创建第一个测试工单",
    },
  },
};
