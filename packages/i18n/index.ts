  ...
  en: {
    translation: {
      ...
      knowledge_file_import: {
        ...
        step_confirm: "Confirm import", local_file: "Local file", supported_files: "Only .md and .txt, up to 10 MB",
        default_modules: "Default ticket modules", default_category: "Default knowledge type", next_settings: "Next: Settings",
        chunk_settings_title: "Choose a chunking method", chunk_settings_description: "Default parameters fit most Markdown files. Choose custom parameters only when you need to change title depth or single-chunk length.",
        ...
        chunk_custom: "Custom parameters", chunk_custom_description: "Choose a title depth or single-chunk length only for unusual file structures.",
        chunk_paragraph_title: "By paragraphs and headings", chunk_paragraph_description: "Candidate titles use the current heading; parent headings provide context only.",
        ...
        chunk_size: "Single content length", chunk_size_hint: "When content exceeds this length, the system continues by paragraphs and punctuation.", previous: "Previous",
        generate_preview: "Generate preview", parsing: "Parsing", review_title: "Review candidate knowledge",
        ...
        error_title_required: "Title cannot be empty", error_modules_required: "Select at least one module",
        ...
        error_file_extension: "Only .md and .txt files are supported", error_file_size: "File cannot exceed 10 MB",
        ...
        error_default_category: "Please select a default knowledge type first", error_chunk_size: "Custom chunk length must be between 64 and 4000",
        error_title_depth: "Title recognition depth must be from H1 to H8", error_duplicate_check: "Duplicate check failed",
        error_no_candidates: "No importable knowledge was parsed. Check the file or adjust the title depth.", error_rechunk_confirm: "Rechunking will replace edits to the current candidates. Continue?",
      ...
      knowledge_error: {
        source_id: "Knowledge ID must use the format general_knowledge:{source_doc_id}:{entry_slug}", title_required: "Title cannot be empty", modules_required: "Select at least one module",
        ...
        file_extension: "Only .md and .txt files are supported", file_size: "File cannot exceed 10 MB", invalid_request: "Invalid request",
        chunk_size: "Custom chunk length must be between 64 and 4000", title_depth: "Title recognition depth must be from H1 to H8", candidates_max: "More than 100 candidates were parsed. Split the file or choose a coarser chunking method.",
  ...
  zh: {
    translation: {
      ...
      knowledge_file_import: {
        ...
        step_confirm: "确认导入", local_file: "本地文件", supported_files: "仅支持 .md、.txt，最大 10 MB",
        default_modules: "默认工单模块", default_category: "默认知识类型", next_settings: "下一步：参数设置",
        chunk_settings_title: "选择分块方式", chunk_settings_description: "默认参数适合大多数 Markdown 文件。需要改变标题层级或单段长度时才选择自定义参数。",
        chunk_default: "默认参数", chunk_default_description: "按 Markdown 标题和自然段落处理，系统自动选择长度和重叠方式。",
        chunk_custom: "自定义参数", chunk_custom_description: "只在文件结构特殊时选择标题深度或单段长度。",
        chunk_paragraph_title: "按段落和标题", chunk_paragraph_description: "候选标题使用当前标题；父级标题只作为正文上下文。",
        title_depth: "识别到第几级标题", title_depth_option: "识别到 H{{level}}", deeper_title_hint: "更深的标题会留在当前知识正文里。",
        chunk_size: "单条内容长度", chunk_size_hint: "内容超过这个长度时，系统会按段落和标点继续处理。", previous: "上一步",
        generate_preview: "生成预览", parsing: "解析中", review_title: "候选知识审核",
        ...
        error_title_required: "标题不能为空", error_modules_required: "至少选择一个模块",
        ...
        error_file_extension: "仅支持 .md 和 .txt 文件", error_file_size: "文件不能超过 10 MB",
        ...
        error_default_category: "请先选择默认知识类型", error_chunk_size: "自定义分块长度必须在 64 到 4000 之间",
        error_title_depth: "标题识别层级必须在 H1 到 H8 之间", error_duplicate_check: "重复检查失败",
        error_no_candidates: "没有解析出可导入的知识，请检查文件内容或调整标题深度", error_rechunk_confirm: "重新分块会替换当前候选的编辑内容，是否继续？",
      ...
      knowledge_error: {
        source_id: "知识 ID 格式应为 general_knowledge:{source_doc_id}:{entry_slug}", title_required: "标题不能为空", modules_required: "至少选择一个模块",
        ...
        file_extension: "仅支持 .md 和 .txt 文件", file_size: "文件不能超过 10 MB", invalid_request: "请求无效",
        chunk_size: "自定义分块长度必须在 64 到 4000 之间", title_depth: "标题识别层级必须在 H1 到 H8 之间", candidates_max: "解析结果超过 100 条，请拆分文件或选择更粗的分块方式",
